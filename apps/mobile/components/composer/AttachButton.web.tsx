  ...
  return (
    <>
      ...
      <input
        ref={inputRef}
        type="file"
        accept="image/*,.pdf,.txt,.md,.markdown,.csv,.tsv,.json,.jsonl,.html,.htm,.xml,.yaml,.yml,.ts,.tsx,.js,.jsx,.py,.rb,.go,.rs,.java,.c,.h,.cpp,.cs,.php,.swift,.kt,.sh,.bash,.zsh,.sql,.toml,.ini,.cfg,.conf,.env,.diff,.patch,.log"
        multiple
