...
ALTER TABLE "inference_providers" ADD CONSTRAINT "inference_providers_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
